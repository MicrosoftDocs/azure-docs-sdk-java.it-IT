...
La versione di Azure Toolkit per Eclipse rilasciata ad aprile 2017 include i miglioramenti seguenti:

* **Accesso ad Azure migliorato**: il Toolkit di Azure per Eclipse supporta ora due metodi di accesso all'account Azure, ovvero *Interattivo* e *Automatico*. Per altre informazioni, vedere [Istruzioni di accesso ad Azure per il Toolkit di Azure per Eclipse].
* **Pubblicazione con i contenitori Docker**: è ora possibile pubblicare le applicazioni Web come contenitori Docker usando il Toolkit di Azure per Eclipse. Per altre informazioni, vedere [Come pubblicare un'app Web come contenitore Docker con il Toolkit di Azure per Eclipse]
* **Gestione degli account di archiviazione**: il Toolkit di Azure per Eclipse supporta ora la gestione degli account di archiviazione dalla visualizzazione Azure Explorer. Per altre informazioni, vedere [Gestione degli account di archiviazione con Azure Explorer per Eclipse].
* **Gestione delle macchine virtuali**: il Toolkit di Azure per Eclipse supporta ora la gestione delle macchine virtuali nella visualizzazione Azure Explorer. Per altre informazioni, vedere [Gestione delle macchine virtuali con Azure Explorer per Eclipse].
* **Rimozione del supporto del debug remoto**. Il debug remoto di app Web Java nel Servizio app di Azure è stato rimosso dal Toolkit di Azure per Eclipse a causa di problemi riscontrati dai clienti quando usavano il toolkit.
...
[plug-in degli strumenti HDInsight per Eclipse]: /azure/hdinsight/hdinsight-apache-spark-eclipse-tool-plugin
