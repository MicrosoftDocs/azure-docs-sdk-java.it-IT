...
> [!NOTE]
>
> Per una versione di questo articolo che fa uso di [Azure Toolkit per IntelliJ], vedere [Creare un'app Web Hello World per Azure con IntelliJ][intellij-hello-world].
>
