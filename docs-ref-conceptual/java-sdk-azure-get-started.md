...
---
# <a name="get-started-with-the-azure-libraries-for-java"></a>Introduzione alle librerie di Azure per Java

Questa guida illustra la configurazione di un ambiente di sviluppo con un'entità servizio di Azure e l'esecuzione del codice di esempio che crea e usa le risorse nella sottoscrizione di Azure con le librerie di Azure per Java.
...
- [Java 8](http://www.oracle.com/technetwork/java/javase/downloads/index.html) (incluso in Azure Cloud Shell)
...
Salvare questo file nel sistema in una posizione sicura e leggibile dal codice. Impostare una variabile di ambiente `AZURE_AUTH_LOCATION` con il percorso completo del file di autenticazione nella shell.    
